...
**It seems people traveling from Times Square tend to pay `r round(cohen_distance$estimate,2)`% more**. While the difference exists and statistically significant the percentage difference is small.
